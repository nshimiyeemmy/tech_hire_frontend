...
export const JobProvider = ({ children }) => {
  ...
  const updateJob = async (id, data, access_token) => {
    try {
      ...
      const res = await axios.put(
        `${process.env.API}/api/jobs/${id}/update/`,
        data,
        {
          headers: {
            Authorization: `Bearer ${access_token}`,
  ...
  const applyToJob = async (id, access_token) => {
    try {
      ...
      const res = await axios.post(
        `${process.env.API}/api/jobs/${id}/apply/`,
        {},
        {
          headers: {
            Authorization: `Bearer ${access_token}`,
  ...
  const checkJobApplied = async (id, access_token) => {
    try {
      ...
      const res = await axios.get(
        `${process.env.API}/api/jobs/${id}/check/`,
        {
          headers: {
            Authorization: `Bearer ${access_token}`,
          },
  ...
  const getTopicStats = async (topic) => {
    try {
      ...
      const res = await axios.get(`${process.env.API}/api/stats/${topic}/`);
  ...
  const deleteJob = async (id, access_token) => {
    try {
      ...
      const res = await axios.delete(
        `${process.env.API}/api/jobs/${id}/delete/`,
        {
          headers: {
            Authorization: `Bearer ${access_token}`,
          },
